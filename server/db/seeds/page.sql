...
('tickets-de',   '/tickets-de',   'de-DE','tickets','Angebote','Angebote – TM Sauber & Mehr UG','Angebote fürs Service & Infos zum Servicepaket.','index,follow', TRUE, TRUE, 30, TRUE,
 ...
 ('team-de',      '/team-de',      'de-DE','team','Team','Team – TM Sauber & Mehr UG','Wer hinter dem Service steht.','index,follow', TRUE, TRUE, 50, TRUE,
  ...
  {"type":"teamAbout","headline":"Unser <em>Team</em> in Übersicht","text":"Lerne die Gesichter kennen, die Sauber & Mehr jeden Tag möglich machen.","breadcrumbLabel":"Über uns","teamEmptyText":"Aktuell sind keine Teammitglieder hinterlegt.","teamMembers":[{"name":"Nadine Hoffmann","role":"Teamleitung","description":"Koordiniert unsere Einsätze und sorgt für einen reibungslosen Ablauf.","image":{"src":"/images/team.webp","alt":"Nadine Hoffmann"}},{"name":"Luca Berger","role":"Objektleitung","description":"Plant die Reinigung vor Ort und begleitet unsere Kundinnen und Kunden.","image":{"src":"/images/team.webp","alt":"Luca Berger"}},{"name":"Meryem Yilmaz","role":"Qualitätssicherung","description":"Prüft jedes Detail und hält die Qualitätsstandards hoch.","image":{"src":"/images/team.webp","alt":"Meryem Yilmaz"}}],"specialsTitle":"Besonders","specialsSubtitle":"Wir bringen das mit, was bei großen Firmen häufig verloren geht:","specialCards":[{"title":"Regional in Berlin","text":"Wir sind lokal verwurzelt und schnell bei dir vor Ort.","icon":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M12 2c-4.1 0-7.4 3.3-7.4 7.4 0 5.2 5.6 11.5 6.6 12.6.4.5 1.2.5 1.6 0 1-1.1 6.6-7.4 6.6-12.6C19.4 5.3 16.1 2 12 2zm0 10.4c-1.7 0-3-1.3-3-3s1.3-3 3-3 3 1.3 3 3-1.3 3-3 3z\"/></svg>"},{"title":"Erreichbarkeit","text":"Wir sind telefonisch, per Mail und WhatsApp schnell für dich erreichbar.","icon":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M6.6 2.4 4 3.8c-1 .5-1.6 1.6-1.4 2.7 1.1 6.5 6.4 11.8 12.9 12.9 1.1.2 2.2-.4 2.7-1.4l1.4-2.6c.4-.8.2-1.8-.6-2.3l-2.8-1.7c-.7-.4-1.7-.3-2.2.4l-.9 1.1c-.4.5-1 .7-1.6.5-2-.6-3.6-2.2-4.2-4.2-.2-.6 0-1.2.5-1.6l1.1-.9c.7-.6.8-1.5.4-2.2L8.9 3c-.5-.8-1.5-1-2.3-.6z\"/></svg>"},{"title":"Leidenschaft","text":"Unser Team arbeitet mit Herz, damit du dich wohlfühlst.","icon":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M12 21s-7.4-4.5-9.7-9.2C.9 8.8 2.2 5.3 5.6 4.3c2-.6 4.1.1 5.4 1.7 1.3-1.6 3.4-2.3 5.4-1.7 3.4 1 4.7 4.5 3.3 7.5C19.4 16.5 12 21 12 21z\"/></svg>"}],"faqTitle":"Gibt es noch weitere Fragen?","faqDescription":"Wir sind rund um die Uhr telefonisch, per Mail oder WhatsApp erreichbar. Eine Antwort erfolgt garantiert innerhalb von 24 Stunden nach Eingang der Nachricht.","faqButton":{"href":"tel:+491795163864","label":"Jetzt anrufen"},"faqItems":[]}
    ]$$::jsonb),
...
('team-en',        '/team-en',        'en-US','team','Team','Team – TM Sauber & Mehr UG','People behind the service.','index,follow', TRUE, TRUE, 50, TRUE,
 $$[
  ...
  {"type":"teamAbout","headline":"Our <em>team</em> at a glance","text":"Meet the people who make Sauber & Mehr possible every day.","breadcrumbLabel":"About us","teamEmptyText":"No team members available right now.","teamMembers":[{"name":"Nadine Hoffmann","role":"Team lead","description":"Coordinates our operations and keeps everything running smoothly.","image":{"src":"/images/team.webp","alt":"Nadine Hoffmann"}},{"name":"Luca Berger","role":"Site manager","description":"Plans on-site cleaning and supports our customers.","image":{"src":"/images/team.webp","alt":"Luca Berger"}},{"name":"Meryem Yilmaz","role":"Quality assurance","description":"Checks every detail and keeps standards high.","image":{"src":"/images/team.webp","alt":"Meryem Yilmaz"}}],"specialsTitle":"Special","specialsSubtitle":"We bring back what large companies often lose:","specialCards":[{"title":"Local in Berlin","text":"We are locally rooted and quickly on site.","icon":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M12 2c-4.1 0-7.4 3.3-7.4 7.4 0 5.2 5.6 11.5 6.6 12.6.4.5 1.2.5 1.6 0 1-1.1 6.6-7.4 6.6-12.6C19.4 5.3 16.1 2 12 2zm0 10.4c-1.7 0-3-1.3-3-3s1.3-3 3-3 3 1.3 3 3-1.3 3-3 3z\"/></svg>"},{"title":"Availability","text":"Reach us quickly via phone, email, or WhatsApp.","icon":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M6.6 2.4 4 3.8c-1 .5-1.6 1.6-1.4 2.7 1.1 6.5 6.4 11.8 12.9 12.9 1.1.2 2.2-.4 2.7-1.4l1.4-2.6c.4-.8.2-1.8-.6-2.3l-2.8-1.7c-.7-.4-1.7-.3-2.2.4l-.9 1.1c-.4.5-1 .7-1.6.5-2-.6-3.6-2.2-4.2-4.2-.2-.6 0-1.2.5-1.6l1.1-.9c.7-.6.8-1.5.4-2.2L8.9 3c-.5-.8-1.5-1-2.3-.6z\"/></svg>"},{"title":"Passion","text":"Our team works with heart so you feel comfortable.","icon":"<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M12 21s-7.4-4.5-9.7-9.2C.9 8.8 2.2 5.3 5.6 4.3c2-.6 4.1.1 5.4 1.7 1.3-1.6 3.4-2.3 5.4-1.7 3.4 1 4.7 4.5 3.3 7.5C19.4 16.5 12 21 12 21z\"/></svg>"}],"faqTitle":"Any further questions?","faqDescription":"We are available by phone, email, or WhatsApp around the clock. We respond within 24 hours after receiving your message.","faqButton":{"href":"tel:+491795163864","label":"Call now"},"faqItems":[]}
   ]$$::jsonb),
